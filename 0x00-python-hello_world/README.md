*0. Run Python file* _ Shell script that runs a Python script.
...
*11. Hello, write* -  Python script that prints exactly and that piece of art is useful - Dora Korpar, 2015-10-19, followed by a new line.
