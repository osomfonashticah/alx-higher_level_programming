...
*7. Safe integer print with error message* - function that prints an integer.
...
*8. Safe function* -  function that executes a function safely.
...
*9. ByteCode -> Python #4* -  Python function def magic_calculation(a, b): that does exactly the same as the following Python bytecode:
...
*10. CPython #2: PyFloatObject* -  C functions that print some basic info about Python lists, Python bytes an Python float objects.
